...
| Diagnose failed CI | [agent-naoru.yml](./.github/workflows/agent-naoru.yml) |
...
| [agent-naoru.yml](./.github/workflows/agent-naoru.yml) | Diagnose failed CI jobs with Clouddrove Agent | Failure triage |
...
| **Failed CI Diagnosis** | agent-naoru.yml |
