## Docker Workflow
#### [1. Docker Scanner workflow reference](https://github.com/clouddrove/github-shared-workflows/blob/master/.github/workflows/06.docker-scanner.yml)
#### [2. Docker push workflow reference](https://github.com/clouddrove/github-shared-workflows/blob/master/.github/workflows/06.docker.yml)

This workflow scans the Docker image locally before pushing it to the Docker registry. Workflows have been added in `.github/workflows/06.docker-scanner.yml`.
...
jobs:
  docker-scanner:
    uses: clouddrove/github-shared-workflows/.github/workflows/06.docker-scanner.yml@master
    with:
  ...
  docker-push:
    ...
    uses: clouddrove/github-shared-workflows/.github/workflows/06.docker.yml@master
    secrets:
