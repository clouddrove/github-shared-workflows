## [Terraform Workflow](https://github.com/clouddrove/github-shared-workflows/blob/master/.github/workflows/28.terraform_workflow.yml)

This workflow is used to apply and destroy terraform infra using GitHub Actions. It utilizes the workflows defined in `.github/workflows/28.terraform_workflow.yml`
...
jobs:
  prod:
    uses: clouddrove/github-shared-workflows/.github/workflows/28.terraform_workflow.yml@master
    with:
        provider:           # aws
